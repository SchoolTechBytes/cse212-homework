public class SimpleQueue
{
    public static void Run()
    {
        ...
        // Defect(s) Found: The Dequeue fuction was targeting the wrong index 1 when it needed to be 0
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: For Enqueue function it needed to change .Insert to .Add becasue it was adding to the front when it needed to add to the back
        ...
        // Defect(s) Found: The Out of range was caught so this is good, no changes.
    }
